...
func defaultPredicates() util.StringSet {
	return util.NewStringSet(
		...
		// Fit is determined by pod conflict selectors not matching.
		factory.RegisterFitPredicate("NoPodConflictSelectorsMatch", predicates.NoPodConflictSelectorsMatch),
	)
}
